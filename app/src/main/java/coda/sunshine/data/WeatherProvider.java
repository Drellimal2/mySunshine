...
/**
 * Created by Dane on 7/3/2015.
 */
public class WeatherProvider extends ContentProvider {

    private WeatherDbHelper weatherDbHelper;
    private static final SQLiteQueryBuilder weatherByLocationSetting;

    static {

        weatherByLocationSetting = new SQLiteQueryBuilder();
        weatherByLocationSetting.setTables(
    ...
    private Cursor getWeatherByLocationSetting(Uri uri, String[] projection, String sortOrder) {
        ...
        return weatherByLocationSetting.query(weatherDbHelper.getReadableDatabase(),
                projection,
                selection,
                selectionArgs,
                null,
