...
*/
         ...
         */
        private ArrayList<WeatherItem> getWeatherDataFromJson(String forecastJsonStr, int numDays)
            ...
            ArrayList<WeatherItem> resultStrs = new ArrayList<>();
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                resultStrs.add(new WeatherItem(day , description + " - " + highAndLow));
            }

            for (WeatherItem s : resultStrs) {
                Log.v("Welp", "Forecast entry: " + s);
            }
            return resultStrs;
        ...
        @Override
        public ArrayList<WeatherItem> doInBackground(String... params) {
            if(params.length == 0){
                return null;
            }
